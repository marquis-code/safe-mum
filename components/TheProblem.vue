      ...
      <div
        ...
        <div
          ...
          <div class="lg:row-start-2 lg:max-w-md">
            <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">The Problems</h2>
          ...
          <img src="@/assets/img/problem.jpg" alt="Product screenshot"
          ...
          <div class="max-w-xl lg:row-start-3 lg:mt-10 lg:max-w-md lg:border-t lg:border-white/10 lg:pt-10">
            <dl class="max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none">
              <div class="relative">
                ...
                <dd class="inline">Many communities in Nigeria and wider Africa face "Limited Access to Quality
              ...
              <div class="relative">
                ...
                <dd class="inline">"Cultural and Language Barriers" in Nigeria and Africa hinder effective healthcare
              ...
              <div class="relative">
                ...
                <dd class="inline">"Inadequate knowledge about pregnancy wellness" is prevalent, leading to increased
              ...
              <div class="relative">
                ...
                <dd class="inline">"Financial Constraints" in Nigeria and Africa limit access to healthcare, with high
